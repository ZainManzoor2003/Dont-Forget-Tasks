          ...
          <div className="followup-panel">
            ...
            <div className="add-note">
              ...
              <div className="actions-row">
                <button className="primary-btn" onClick={handleAddNote} disabled={!newNote.trim()}>Save Note</button>
                <button className="secondary-btn" onClick={handleMarkComplete}>Mark Task Complete</button>
              </div>
            </div>
          </div>
        </div>
